//
//  MockHomeSceneCoordinator.swift
//  FeatureSplash
//
...
final class MockHomeSceneCoordinator: Coordinator {
    ...
    func start() {
        let alertController = UIAlertController(title: "알림", message: "HomeScene입니다.", preferredStyle: .alert)
